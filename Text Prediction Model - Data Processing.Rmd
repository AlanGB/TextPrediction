...
For this next step we will prepare our data before creating the models. The pipeline we will follow  is as follows:
        ...
        1. **Remove special characters:** the punctuaction signs and other special characters, including numbers will be removed.
